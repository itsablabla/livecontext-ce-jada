...
interface DialogContentProps
  ...
  /**
   * Extra classes for the backdrop behind this dialog. Needed only to raise a
   * dialog above a floating host that paints above the default z-[9999] (the
   * composer menu and its options panel): the content and its overlay must move
   * together, or the dialog appears over a backdrop that is under the menu it
   * was opened from.
   */

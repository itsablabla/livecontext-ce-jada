...
import PlatformStatusCard from '@/components/settings/PlatformStatusCard';
...
export default function InformationPage() {
  ...
  // Platform status is the mirror image: it reports on OUR cloud, which a
  // self-hosted install neither runs nor depends on, so it is cloud only.

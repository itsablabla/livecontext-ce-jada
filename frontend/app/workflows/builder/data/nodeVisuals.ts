...
export const NODE_ICON_REGISTRY: Record<string, NodeIconEntry> = {
  ...
  'generate': { icon: Sparkles, iconBg: AI_BG },
  'generation': { icon: Sparkles, iconBg: AI_BG },
  'text-to-image': { icon: Sparkles, iconBg: AI_BG },
  'text-to-video': { icon: Sparkles, iconBg: AI_BG },
  'text-to-speech': { icon: Sparkles, iconBg: AI_BG },
